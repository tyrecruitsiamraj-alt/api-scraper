...
export const FLOW_COLUMNS: { key: FlowStage; label: string; hint: string }[] = [
  { key: 'new', label: 'งานใหม่', hint: 'เพิ่งรับจาก ERP' },
  { key: 'researching', label: 'สำรวจแนว', hint: 'หาแนว content ที่เคยเวิร์ค' },
  { key: 'drafting', label: 'คิด content', hint: 'AI เขียนแคปชัน/ภาพ' },
  { key: 'pending_approval', label: 'รออนุมัติ', hint: 'คนต้องกดอนุมัติ' },
  { key: 'approved', label: 'อนุมัติแล้ว', hint: 'รอเข้าคิวโพสต์' },
  { key: 'posting', label: 'กำลังโพสต์', hint: 'Autopost กำลังลงกลุ่ม' },
  { key: 'measuring', label: 'วัดผล', hint: 'รอ engagement / leads' },
  { key: 'low_engagement', label: 'คนสนใจน้อย', hint: 'วนกลับคิด content ใหม่' },
  { key: 'done', label: 'เสร็จ', hint: 'ปิดงาน' },
];
...
export const MOCK_FLOW: MockFlowItem[] = [
  ...
  },
  {
    ...
    remaining_qty: 2,
    status: 'researching',
    doing: 'กำลังเทียบแนวที่เคยได้ leads สูงใน Job Family เดียวกัน',
    blocked: null,
    owner: 'AI Research',
  ...
  },
  {
    ...
    doing: 'วัดผลแล้วคะแนนต่ำ — วนคิวให้ AI คิด content ใหม่ (v3)',
    blocked: 'รอบก่อนแคปชัน generic เกินไป (pattern ถูกบันทึกเป็นหลีกเลี่ยง)',
    owner: 'ระบบ (regen)',
  ...
  },
  {
    ...
    remaining_qty: 3,
    status: 'low_engagement',
    doing: 'รอเริ่มร่างรอบใหม่หลัง low_engagement',
    blocked: 'ไม่มี ANTHROPIC_API_KEY บน worker — คิว draft ค้าง',
    owner: 'Worker · draft',
