...
# เอาบรรทัดเก่าของ seo-update ออกก่อน (กันซ้ำ/path เปลี่ยน) แล้วใส่ใหม่
( crontab -l 2>/dev/null | grep -v 'seo-update.mjs' ; echo "$LINE" ) | crontab -

echo "✓ ติดตั้งแล้ว: รันทุกวันจันทร์ 08:30"
echo "  $LINE"
echo
