...
| 25 ส.ค. 2026 | ปิด UX feedback ของ Poster Editor: ระหว่างทำงานปุ่มแสดง `กำลังประกอบรูป…`; เมื่อสำเร็จแสดงผลใต้ปุ่มทันทีแทนให้ผู้ใช้เดา; ผู้ใช้ยืนยันผ่านหน้า Web | Codex |
