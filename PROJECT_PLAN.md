...
| UX-02 | ทำแล้ว | เพิ่ม Display Identity กลาง ไม่ใช้เนื้องานเต็มเป็นหัวข้อ และแสดงเลขใบขอ/พื้นที่/Connector เป็นบริบท | ตรวจข้อมูลใบขอที่ไม่มีตำแหน่ง เพื่อยืนยันว่าไม่ต้องเดา |
...
| UX-07 | ทำแล้วในจุดเสี่ยง | เพิ่ม Human Message Map สำหรับสิทธิ์ JobBKK, Worker, Login/Session; Raw error อยู่ใน `รายละเอียดสำหรับผู้ดูแล` | เก็บ Message Map ให้ครอบคลุม Error ใหม่ทุกชนิด |
