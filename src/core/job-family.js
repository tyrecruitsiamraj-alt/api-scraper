...
export async function positionsFromDescription({ description, province, platform } = {}) {
  ...
  const res = await callModel({
    system:
      ...
      '\n\n## สำคัญมาก: คำค้นต้องเป็นภาษาไทยเท่านั้น\nเว็บหางานเป็นเว็บไทย เรซูเม่คนไทยตั้งชื่อตำแหน่งเป็นไทย ถ้าตอบเป็นอังกฤษจะค้นไม่เจอเลย (ได้ 0 คน). แม้เนื้องานจะเต็มไปด้วยศัพท์อังกฤษ ก็ต้องแปลงเป็นคำไทยที่ใช้จริง เช่น "Software Sales/Account Executive"→"พนักงานขาย","นักขายไอที"; "Pre-Sales/Solution Consultant"→"ที่ปรึกษาการขาย","เจ้าหน้าที่พรีเซล"; "Business Development"→"นักพัฒนาธุรกิจ","เจ้าหน้าที่พัฒนาธุรกิจ"; "Programmer/Developer"→"โปรแกรมเมอร์","นักพัฒนาโปรแกรม". ห้ามมีตัวอักษรอังกฤษในคำค้นแม้แต่คำเดียว' +
